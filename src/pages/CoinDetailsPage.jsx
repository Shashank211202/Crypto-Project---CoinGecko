...
function CoinDetailsPage() {
  ...
  const { isLoading, isError, coin } = useFetchCoin(coinId);
  ...
  return (
    <div className="flex flex-col md:flex-row">
      <div className="md:w-1/3 w-full flex flex-col items-center mt-6 md:mt-0 border-r-2 border-gray-500 ">
        ...
        <p className="w-full px-5 py-4 text-justify">
          {parse(coin?.description.en)}
        </p>
        <div className="w-full flex flex-col ml-10 md:ml-0 md:flex-row md:justify-around">
